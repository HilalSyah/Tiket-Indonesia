...
import { productWisata } from "../lib/Pink";
...
import CheckoutWisata4 from "../Components/CheckoutWisata4";
        ...
        <main className="max-w-xl mx-auto sm:p-16">
          <div className="chek border-[2px] h-[45rem] border-slate-400 rounded-[1rem] shadow-md shadow-slate-600 bg-white">
            <div className="flex flex-col">
              <Image src="/Gambar5.png" alt="Wisata Gambar" width={250} height={250} objectFit="cover" className="w-full rounded-t-[1rem]" />
