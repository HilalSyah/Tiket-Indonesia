...
export const Pesawat_Tiket = () => {
  ...
  return (
    <div className="Kapal_Tiket min-h-screen bg-bgWisata2 bg-no-repeat bg-cover bg-center flex">
      ...
      <div className="pesan-tiket bg-trasnparant w-[500px] h-[700px] flex flex-col justify-start items-start mt-[1.5rem] rounded-[10px] font-lexend gap-[2rem] p-[3.5rem] transition-all duration-500">
        <div className="dari">
          <p className="text-2xl font-bold">Tujuan</p>
          <div className="bg-[#E6E6E6] w-[25rem] h-[2.5rem] rounded-[5px]">
            <select className="bg-[#E6E6E6] w-[24rem] h-[2.5rem] border-none outline-none text text-[20px] ms-2" value={dari} onChange={(e) => setDari(e.target.value)}>
              ...
              <option value="Jakarta">Bromo</option>
              <option value="Bandung">Danau Toba</option>
              <option value="Jogja">Labuan Bajo</option>
              <option value="Pontianak">Raja Ampat</option>
              <option value="Surabaya">Pantai Pink</option>
              <option value="Bali">Pantai Derawan</option>
              <option value="Yogyakarta">Pantai Ngurtafur</option>
              <option value="Yogyakarta">Pantai Ora</option>
            </select>
          </div>
        </div>
        ...
        <div className="jenis">
          <p className="text-2xl font-bold">Jenis Kendaraan</p>
          <div className="bg-[#E6E6E6] w-[25rem] h-[2.5rem] rounded-[7px]">
            <select className="bg-[#E6E6E6] w-[24rem] h-[2.5rem] border-none outline-none text-[20px] ms-2" value={jenis} onChange={(e) => setJenis(e.target.value)}>
              <option value="" disabled>
                Pilih jenis Kendaaran
              </option>
              <option value="Citilink">Bus</option>
              <option value="Batik Air">elf</option>
              <option value="Lion Air">Mobil</option>
            </select>
          </div>
        </div>
        <Link href="/Wisata5">
