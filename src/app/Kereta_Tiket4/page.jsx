...
export const Kereta_Tiket = () => {
  ...
  return (
    <div className="Kapal_Tiket min-h-screen bg-bgTiketKereta bg-no-repeat bg-cover bg-center flex">
      ...
      <div className="pesan-tiket bg-trasnparant w-[500px] h-[700px] flex flex-col justify-start items-start mt-[4rem] rounded-[10px] font-lexend gap-[2rem] p-[3.5rem] transition-all duration-500">
